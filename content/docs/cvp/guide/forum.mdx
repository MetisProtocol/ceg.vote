...
The voting period is 5 days and is published on [Metis Snapshot](https://proposals.ceg.vote). During this 5 day period, the project must meet the required quorum. Projects that pass the vote (80% YES, [Optimistic Quorum](https://docs.snapshot.box/snapshot-x/protocol/execution-strategies#optimistic-quorum)) will be granted Community Verified Project status.
